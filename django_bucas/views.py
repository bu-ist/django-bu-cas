...
##      request.user.message_set.create(message=message)	#  user Message model deprecated in Django 1.2
...
##          user.message_set.create(message=message)	#  user Message model deprecated in Django 1.2
            messages.add_message(request, messages.INFO, message)
            return HttpResponseRedirect(next_page)
